# this file is taken initially from the sbi toolbox tutorial:
...
def run_HH_model(params):
    """runs the Hodgkin-Huxle

    Args:
        params (array): gNa and gK and tau_max. shape (1,3)
...
def syn_current(duration=120, dt=0.01, t_on=10, curr_level=5e-4, seed=None):
    """Generates a synthetic current

    Args:
        duration (int, optional): _description_. Defaults to 120.
        dt (float, optional): _description_. Defaults to 0.01.
        t_on (int, optional): _description_. Defaults to 10.
        curr_level (_type_, optional): _description_. Defaults to 5e-4.
        seed (_type_, optional): _description_. Defaults to None.

    Returns:
        _type_: I, t_on, t_off, dt, t, A_soma
    """
    duration = duration
    t_off = duration - t_on
